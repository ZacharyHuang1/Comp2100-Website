...
This file defines the SortedData class in the sorteddata package. It belongs to src/sorteddata in the COMP2100 MiniLab codebase and contains implementation logic for its codebase module. Key methods include insert, get, getAtIndex, getRange, getAll.
...
class SortedData {
  ...
  +getAll() Iterator<T>
  ~getRange(null: Object, -1: Object, false: Object) return
  +getRandom() T
}
```
