...
## Path
test/AVLTreeTests.java

## Explanation

This test file defines the AVLTreeTests class. It belongs to test in the COMP2100 MiniLab codebase and verifies behavior of the avl tree implementation. It uses JUnit 4 style testing through org.junit imports. Key methods include treeWith, testEmpty, testInsertion, testDuplicates, testLeftRotate.
...
class AVLTreeTests {
  <<test>>
  -treeWith(values: int...) AVLTree<Integer>
  +testEmpty() void
  +testInsertion() void
  +testDuplicates() void
  +testLeftRotate() void
  +testRightRotate() void
  +testLeftRightRotate() void
  +testRightLeftRotate() void
