...
## Path
test/Mock_hackathon/DesignPatterns/DP05_SortedDataFactoryExtensionTest.java

## Explanation

This test file defines the DP05_SortedDataFactoryExtensionTest class in the hackathon package. It belongs to test/Mock_hackathon/DesignPatterns in the COMP2100 MiniLab codebase and verifies behavior of the dp05 sorted data factory extension implementation. It uses JUnit 4 style testing through org.junit imports. Key methods include saveStoresValue, ruleCanDenyAction, listenerReceivesEvents, deleteRemovesStoredValue, undoRestoresPreviousState.
...
```mermaid
classDiagram
class DP05_SortedDataFactoryExtensionTest {
  <<test>>
...
/**
 * Tests DP05: SortedData factory extension.
 */
public class DP05_SortedDataFactoryExtensionTest {
    // Verifies that saving stores values by key.
    @Test
    public void saveStoresValue() {
        DP05_SortedDataFactoryExtension service = new DP05_SortedDataFactoryExtension();
