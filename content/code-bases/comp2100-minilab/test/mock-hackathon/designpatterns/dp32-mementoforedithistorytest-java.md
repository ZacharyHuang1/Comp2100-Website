...
```mermaid
classDiagram
class DP32_MementoForEditHistoryTest {
  <<test>>
...
/**
 * Tests DP32: Memento for edit history.
 */
public class DP32_MementoForEditHistoryTest {
    // Verifies that saving stores values by key.
    @Test
    public void saveStoresValue() {
        DP32_MementoForEditHistory service = new DP32_MementoForEditHistory();
