...
```mermaid
classDiagram
class DP02_RepositoryLayerTest {
  <<test>>
...
/**
 * Tests DP02: Repository layer.
 */
public class DP02_RepositoryLayerTest {
    // Verifies that saving stores values by key.
    @Test
    public void saveStoresValue() {
        DP02_RepositoryLayer service = new DP02_RepositoryLayer();
