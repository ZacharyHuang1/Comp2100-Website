...
```mermaid
classDiagram
class DP11_ObserverNotificationsTest {
  <<test>>
...
/**
 * Tests DP11: Observer notifications.
 */
public class DP11_ObserverNotificationsTest {
    // Verifies that saving stores values by key.
    @Test
    public void saveStoresValue() {
        DP11_ObserverNotifications service = new DP11_ObserverNotifications();
