...
## Path
test/Mock_hackathon/DesignPatterns/DP26_FormattedDataAdapterTest.java

## Explanation

This test file defines the DP26_FormattedDataAdapterTest class in the hackathon package. It belongs to test/Mock_hackathon/DesignPatterns in the COMP2100 MiniLab codebase and verifies behavior of the dp26 formatted data adapter implementation. It uses JUnit 4 style testing through org.junit imports. Key methods include saveStoresValue, ruleCanDenyAction, listenerReceivesEvents, deleteRemovesStoredValue, undoRestoresPreviousState.
...
```mermaid
classDiagram
class DP26_FormattedDataAdapterTest {
  <<test>>
...
/**
 * Tests DP26: Formatted data adapter.
 */
public class DP26_FormattedDataAdapterTest {
    // Verifies that saving stores values by key.
    @Test
    public void saveStoresValue() {
        DP26_FormattedDataAdapter service = new DP26_FormattedDataAdapter();
