...
## Path
test/Mock_hackathon/DataStructures/DS36_TopKWordCounterTest.java

## Explanation

This test file defines the DS36_TopKWordCounterTest class in the hackathon package. It belongs to test/Mock_hackathon/DataStructures in the COMP2100 MiniLab codebase and verifies behavior of the ds36 top k word counter implementation. It uses JUnit 4 style testing through org.junit imports. Key methods include emptyQueueHasNoNextItem, higherPriorityDequeuesFirst, equalPriorityUsesInsertionOrder, removeDeletesQueuedItem, enqueueSameIdReplacesEntry.
...
```mermaid
classDiagram
class DS36_TopKWordCounterTest {
  <<test>>
...
/**
 * Tests DS36: Top-K word counter.
 */
public class DS36_TopKWordCounterTest {
    // Verifies that a new queue is empty.
    @Test
    public void emptyQueueHasNoNextItem() {
        DS36_TopKWordCounter queue = new DS36_TopKWordCounter();
