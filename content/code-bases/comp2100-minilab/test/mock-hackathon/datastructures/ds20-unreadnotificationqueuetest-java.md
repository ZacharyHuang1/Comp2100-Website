...
```mermaid
classDiagram
class DS20_UnreadNotificationQueueTest {
  <<test>>
...
/**
 * Tests DS20: Unread notification queue.
 */
public class DS20_UnreadNotificationQueueTest {
    // Verifies that a new queue is empty.
    @Test
    public void emptyQueueHasNoNextItem() {
        DS20_UnreadNotificationQueue queue = new DS20_UnreadNotificationQueue();
