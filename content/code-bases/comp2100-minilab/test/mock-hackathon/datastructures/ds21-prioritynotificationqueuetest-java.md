...
## Path
test/Mock_hackathon/DataStructures/DS21_PriorityNotificationQueueTest.java

## Explanation

This test file defines the DS21_PriorityNotificationQueueTest class in the hackathon package. It belongs to test/Mock_hackathon/DataStructures in the COMP2100 MiniLab codebase and verifies behavior of the ds21 priority notification queue implementation. It uses JUnit 4 style testing through org.junit imports. Key methods include emptyQueueHasNoNextItem, higherPriorityDequeuesFirst, equalPriorityUsesInsertionOrder, removeDeletesQueuedItem, enqueueSameIdReplacesEntry.
...
```mermaid
classDiagram
class DS21_PriorityNotificationQueueTest {
  <<test>>
...
/**
 * Tests DS21: Priority notification queue.
 */
public class DS21_PriorityNotificationQueueTest {
    // Verifies that a new queue is empty.
    @Test
    public void emptyQueueHasNoNextItem() {
        DS21_PriorityNotificationQueue queue = new DS21_PriorityNotificationQueue();
