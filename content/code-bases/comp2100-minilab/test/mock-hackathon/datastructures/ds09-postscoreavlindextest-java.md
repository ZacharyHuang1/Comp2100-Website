...
## Path
test/Mock_hackathon/DataStructures/DS09_PostScoreAVLIndexTest.java

## Explanation

This test file defines the DS09_PostScoreAVLIndexTest class in the hackathon package. It belongs to test/Mock_hackathon/DataStructures in the COMP2100 MiniLab codebase and verifies behavior of the ds09 post score avl index implementation. It uses JUnit 4 style testing through org.junit imports. Key methods include emptyRangeHasNoFirstValue, betweenIncludesBoundaries, betweenExcludesOutsideValues, firstAndLastUseSortedKeys, removeUpdatesCount.
...
```mermaid
classDiagram
class DS09_PostScoreAVLIndexTest {
  <<test>>
...
/**
 * Tests DS09: Post score AVL index.
 */
public class DS09_PostScoreAVLIndexTest {
    // Verifies that an empty range has no first value.
    @Test
    public void emptyRangeHasNoFirstValue() {
        DS09_PostScoreAVLIndex range = new DS09_PostScoreAVLIndex();
