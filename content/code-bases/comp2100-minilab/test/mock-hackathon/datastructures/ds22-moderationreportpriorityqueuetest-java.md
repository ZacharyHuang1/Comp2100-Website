...
```mermaid
classDiagram
class DS22_ModerationReportPriorityQueueTest {
  <<test>>
...
/**
 * Tests DS22: Moderation report priority queue.
 */
public class DS22_ModerationReportPriorityQueueTest {
    // Verifies that a new queue is empty.
    @Test
    public void emptyQueueHasNoNextItem() {
        DS22_ModerationReportPriorityQueue queue = new DS22_ModerationReportPriorityQueue();
