...
```mermaid
classDiagram
class DS29_RecentPostDequeTest {
  <<test>>
...
/**
 * Tests DS29: Recent post deque.
 */
public class DS29_RecentPostDequeTest {
    // Verifies that an empty index returns no ids.
    @Test
    public void emptyIndexReturnsNoResults() {
        DS29_RecentPostDeque index = new DS29_RecentPostDeque();
