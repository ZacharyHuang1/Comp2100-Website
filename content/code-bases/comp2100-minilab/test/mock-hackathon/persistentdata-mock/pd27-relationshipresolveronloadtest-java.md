...
## Path
test/Mock_hackathon/PersistentData_Mock/PD27_RelationshipResolverOnLoadTest.java

## Explanation

This test file defines the PD27_RelationshipResolverOnLoadTest class in the hackathon package. It belongs to test/Mock_hackathon/PersistentData_Mock in the COMP2100 MiniLab codebase and verifies behavior of the pd27 relationship resolver on load implementation. It uses JUnit 4 style testing through org.junit imports. Key methods include saveAndFindRecord, deleteRecordRemovesValue, serializeAndLoadRoundTripsEscapedData, blankKeyIsRejected, csvEscapingHandlesSpecialCharacters.
...
```mermaid
classDiagram
class PD27_RelationshipResolverOnLoadTest {
  <<test>>
...
/**
 * Tests PD27: Relationship resolver on load.
 */
public class PD27_RelationshipResolverOnLoadTest {
    // Verifies that saved records can be read back.
    @Test
    public void saveAndFindRecord() {
        PD27_RelationshipResolverOnLoad store = new PD27_RelationshipResolverOnLoad();
    ...
    public void serializeAndLoadRoundTripsEscapedData() {
        ...
        PD27_RelationshipResolverOnLoad loaded = new PD27_RelationshipResolverOnLoad();
