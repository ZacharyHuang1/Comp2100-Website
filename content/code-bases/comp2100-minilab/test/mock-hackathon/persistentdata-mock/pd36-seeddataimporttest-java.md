...
## Path
test/Mock_hackathon/PersistentData_Mock/PD36_SeedDataImportTest.java

## Explanation

This test file defines the PD36_SeedDataImportTest class in the hackathon package. It belongs to test/Mock_hackathon/PersistentData_Mock in the COMP2100 MiniLab codebase and verifies behavior of the pd36 seed data import implementation. It uses JUnit 4 style testing through org.junit imports. Key methods include saveAndFindRecord, deleteRecordRemovesValue, serializeAndLoadRoundTripsEscapedData, blankKeyIsRejected, csvEscapingHandlesSpecialCharacters.
