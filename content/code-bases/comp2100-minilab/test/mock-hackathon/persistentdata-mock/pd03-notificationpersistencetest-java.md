...
## Path
test/Mock_hackathon/PersistentData_Mock/PD03_NotificationPersistenceTest.java

## Explanation

This test file defines the PD03_NotificationPersistenceTest class in the hackathon package. It belongs to test/Mock_hackathon/PersistentData_Mock in the COMP2100 MiniLab codebase and verifies behavior of the pd03 notification persistence implementation. It uses JUnit 4 style testing through org.junit imports. Key methods include saveAndFindRecord, deleteRecordRemovesValue, serializeAndLoadRoundTripsEscapedData, blankKeyIsRejected, csvEscapingHandlesSpecialCharacters.
...
```mermaid
classDiagram
class PD03_NotificationPersistenceTest {
  <<test>>
...
/**
 * Tests PD03: Notification persistence.
 */
public class PD03_NotificationPersistenceTest {
    // Verifies that saved records can be read back.
    @Test
    public void saveAndFindRecord() {
        PD03_NotificationPersistence store = new PD03_NotificationPersistence();
    ...
    public void serializeAndLoadRoundTripsEscapedData() {
        ...
        PD03_NotificationPersistence loaded = new PD03_NotificationPersistence();
