...
```mermaid
classDiagram
class PD15_UserSettingsPersistenceTest {
  <<test>>
...
/**
 * Tests PD15: User settings persistence.
 */
public class PD15_UserSettingsPersistenceTest {
    // Verifies that saved records can be read back.
    @Test
    public void saveAndFindRecord() {
        PD15_UserSettingsPersistence store = new PD15_UserSettingsPersistence();
    ...
    public void serializeAndLoadRoundTripsEscapedData() {
        ...
        PD15_UserSettingsPersistence loaded = new PD15_UserSettingsPersistence();
