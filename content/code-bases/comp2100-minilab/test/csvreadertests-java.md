...
## Path
test/CSVReaderTests.java

## Explanation

This test file defines the CSVReaderTests class. It belongs to test in the COMP2100 MiniLab codebase and verifies behavior of the csv reader implementation. It uses JUnit 4 style testing through org.junit imports. Key methods include parameters, testFile, assertRowEquals.
...
class CSVReaderTests {
  ...
  +testFile() void
  -assertRowEquals(expected: String[], actual: String[]) void
}
```
