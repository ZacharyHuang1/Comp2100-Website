...
## Path
test/AVLIteratorTests.java

## Explanation

This test file defines the AVLIteratorTests class. It belongs to test in the COMP2100 MiniLab codebase and verifies behavior of the avl iterator implementation. It uses JUnit 4 style testing through org.junit imports. Key methods include exampleTest, testEmptyRootHasNoNext, testCountZeroHasNextFalseButNextStillReturnsCurrent, testForwardBeginGreaterThanCurrentFindsLargerElement, testBackwardsFromNullStartsAtRightmost.
...
```mermaid
classDiagram
class AVLIteratorTests {
  <<test>>
  +exampleTest() void
  +testEmptyRootHasNoNext() void
  +testCountZeroHasNextFalseButNextStillReturnsCurrent() void
  +testForwardBeginGreaterThanCurrentFindsLargerElement() void
  +testBackwardsFromNullStartsAtRightmost() void
  +testBackwardsBeginSkipsLargerValues() void
  +testForwardFromNullStartsAtLeftmost() void
}
```
