...
```mermaid
classDiagram
class PD17_HashtagIndexSnapshotTest {
  <<test>>
...
/**
 * Tests PD17: Hashtag index snapshot.
 */
public class PD17_HashtagIndexSnapshotTest {
    // Verifies that saved records can be read back.
    @Test
    public void saveAndFindRecord() {
        PD17_HashtagIndexSnapshot store = new PD17_HashtagIndexSnapshot();
    ...
    public void serializeAndLoadRoundTripsEscapedData() {
        ...
        PD17_HashtagIndexSnapshot loaded = new PD17_HashtagIndexSnapshot();
