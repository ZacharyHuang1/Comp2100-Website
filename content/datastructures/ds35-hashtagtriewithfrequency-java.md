...
DS35_HashtagTrieWithFrequency is a Mock_hackathon practice implementation for DS35: Hashtag trie with frequency. It is stored separately from the original MiniLab packages so it can be studied as an extension-style hackathon task without changing the base codebase.

The feature is: Suggest hashtags by prefix and popularity. The task is: Trie nodes with terminal frequency count.
...
PlantUML guidance:
DS35_HashtagTrieWithFrequency ..> Post : reads post id/topic
DS35_HashtagTrieWithFrequency ..> Message : reads message id/text/timestamp
DS35_HashtagTrieWithFrequency ..> User : reads user id/username

## UML

```mermaid
classDiagram
class DS35_HashtagTrieWithFrequency {
  - Node root
  - int wordCount
...
class Node
DS35_HashtagTrieWithFrequency *-- Node
class Post
class Message
class User
DS35_HashtagTrieWithFrequency ..> Post : accepts model object
DS35_HashtagTrieWithFrequency ..> Message : accepts model object
DS35_HashtagTrieWithFrequency ..> User : accepts model object
```
