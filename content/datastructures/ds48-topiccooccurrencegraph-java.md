...
DS48_TopicCoOccurrenceGraph is a Mock_hackathon practice implementation for DS48: Topic co-occurrence graph. It is stored separately from the original MiniLab packages so it can be studied as an extension-style hackathon task without changing the base codebase.

The feature is: Connect topics that appear together in posts. The task is: Undirected weighted graph.
...
PlantUML guidance:
DS48_TopicCoOccurrenceGraph ..> Post : reads post id/topic
DS48_TopicCoOccurrenceGraph ..> Message : reads message id/text/timestamp
DS48_TopicCoOccurrenceGraph ..> User : reads user id/username
...
class Message
class User
DS48_TopicCoOccurrenceGraph ..> Post : accepts model object
DS48_TopicCoOccurrenceGraph ..> Message : accepts model object
DS48_TopicCoOccurrenceGraph ..> User : accepts model object
```
