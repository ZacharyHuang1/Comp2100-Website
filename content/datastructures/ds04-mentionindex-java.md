...
DS04_MentionIndex is a Mock_hackathon practice implementation for DS04: Mention index. It is stored separately from the original MiniLab packages so it can be studied as an extension-style hackathon task without changing the base codebase.

The feature is: Track @username mentions in posts/messages. The task is: Map mentioned username or userId to all mentioning content.
...
PlantUML guidance:
DS04_MentionIndex ..> Post : reads post id/topic
DS04_MentionIndex ..> Message : reads message id/text/timestamp
DS04_MentionIndex ..> User : reads user id/username

## UML

```mermaid
classDiagram
class DS04_MentionIndex {
...
class Message
class User
DS04_MentionIndex ..> Post : accepts model object
DS04_MentionIndex ..> Message : accepts model object
DS04_MentionIndex ..> User : accepts model object
```
...
/**
 * DS04 practice implementation for mention index.
 */
public class DS04_MentionIndex {
