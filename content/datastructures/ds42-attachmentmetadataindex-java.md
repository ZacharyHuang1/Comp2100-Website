...
DS42_AttachmentMetadataIndex is a Mock_hackathon practice implementation for DS42: Attachment metadata index. It is stored separately from the original MiniLab packages so it can be studied as an extension-style hackathon task without changing the base codebase.

The feature is: Index attachments by file type, owner, or post. The task is: Maps from owner/post/type to attachment ids.
...
PlantUML guidance:
DS42_AttachmentMetadataIndex ..> Post : reads post id/topic
DS42_AttachmentMetadataIndex ..> Message : reads message id/text/timestamp
DS42_AttachmentMetadataIndex ..> User : reads user id/username
...
class Message
class User
DS42_AttachmentMetadataIndex ..> Post : accepts model object
DS42_AttachmentMetadataIndex ..> Message : accepts model object
DS42_AttachmentMetadataIndex ..> User : accepts model object
```
