...
DS27_CommentBreadthFirstIterator is a Mock_hackathon practice implementation for DS27: Comment breadth-first iterator. It is stored separately from the original MiniLab packages so it can be studied as an extension-style hackathon task without changing the base codebase.

The feature is: Traverse comments level by level. The task is: Queue-based BFS iterator.
...
PlantUML guidance:
DS27_CommentBreadthFirstIterator ..> Post : reads post id/topic
DS27_CommentBreadthFirstIterator ..> Message : reads message id/text/timestamp
DS27_CommentBreadthFirstIterator ..> User : reads user id/username

## UML

```mermaid
classDiagram
class DS27_CommentBreadthFirstIterator {
...
class Entry
DS27_CommentBreadthFirstIterator *-- Entry
class Post
class Message
class User
DS27_CommentBreadthFirstIterator ..> Post : accepts model object
DS27_CommentBreadthFirstIterator ..> Message : accepts model object
DS27_CommentBreadthFirstIterator ..> User : accepts model object
```
...
/**
 * DS27 practice implementation for comment breadth-first iterator.
 */
public class DS27_CommentBreadthFirstIterator {
    private final PriorityQueue<Entry> queue = new PriorityQueue<>();
    private final Map<UUID, Entry> entries = new HashMap<>();
    private long sequence;

    // Creates an empty priority queue.
    public DS27_CommentBreadthFirstIterator() {
    }
