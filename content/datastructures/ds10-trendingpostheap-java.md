...
DS10_TrendingPostHeap is a Mock_hackathon practice implementation for DS10: Trending post heap. It is stored separately from the original MiniLab packages so it can be studied as an extension-style hackathon task without changing the base codebase.

The feature is: Return top N active posts efficiently. The task is: Use a priority queue for quick top retrieval; handle score updates carefully.
...
PlantUML guidance:
DS10_TrendingPostHeap ..> Post : reads post id/topic
DS10_TrendingPostHeap ..> Message : reads message id/text/timestamp
DS10_TrendingPostHeap ..> User : reads user id/username

## UML

```mermaid
classDiagram
class DS10_TrendingPostHeap {
  - Node root
  - int wordCount
...
class Node
DS10_TrendingPostHeap *-- Node
class Post
class Message
class User
DS10_TrendingPostHeap ..> Post : accepts model object
DS10_TrendingPostHeap ..> Message : accepts model object
DS10_TrendingPostHeap ..> User : accepts model object
```
...
/**
 * DS10 practice implementation for trending post heap.
 */
public class DS10_TrendingPostHeap {
    private final Node root = new Node();
    private int wordCount;

    // Creates an empty trie.
    public DS10_TrendingPostHeap() {
    }
