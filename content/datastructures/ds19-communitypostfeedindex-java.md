...
DS19_CommunityPostFeedIndex is a Mock_hackathon practice implementation for DS19: Community post feed index. It is stored separately from the original MiniLab packages so it can be studied as an extension-style hackathon task without changing the base codebase.

The feature is: Store posts inside communities sorted by time/score. The task is: Map community to sorted post collection.
...
PlantUML guidance:
DS19_CommunityPostFeedIndex ..> Post : reads post id/topic
DS19_CommunityPostFeedIndex ..> Message : reads message id/text/timestamp
DS19_CommunityPostFeedIndex ..> User : reads user id/username
DS19_CommunityPostFeedIndex ..> SortedData : returns snapshot
DS19_CommunityPostFeedIndex ..> SortedDataFactory : builds factory-backed snapshot
DS19_CommunityPostFeedIndex ..> AVLTree : exposes AVL snapshot
DS19_CommunityPostFeedIndex ..> BSTree : exposes BST snapshot
DS19_CommunityPostFeedIndex ..> SortedArrayList : exposes array snapshot

## UML

```mermaid
classDiagram
class DS19_CommunityPostFeedIndex {
...
class Message
class User
DS19_CommunityPostFeedIndex ..> Post : accepts model object
DS19_CommunityPostFeedIndex ..> Message : accepts model object
DS19_CommunityPostFeedIndex ..> User : accepts model object
class SortedData
...
DS19_CommunityPostFeedIndex ..> SortedData : returns snapshot
DS19_CommunityPostFeedIndex ..> SortedDataFactory : builds snapshot
DS19_CommunityPostFeedIndex ..> AVLTree : builds AVL snapshot
DS19_CommunityPostFeedIndex ..> BSTree : builds BST snapshot
DS19_CommunityPostFeedIndex ..> SortedArrayList : builds array snapshot
```
