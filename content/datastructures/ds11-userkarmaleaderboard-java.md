...
DS11_UserKarmaLeaderboard is a Mock_hackathon practice implementation for DS11: User karma leaderboard. It is stored separately from the original MiniLab packages so it can be studied as an extension-style hackathon task without changing the base codebase.

The feature is: Rank users by reputation or karma. The task is: Map users to scores and maintain a sorted leaderboard.
...
PlantUML guidance:
DS11_UserKarmaLeaderboard ..> Post : reads post id/topic
DS11_UserKarmaLeaderboard ..> Message : reads message id/text/timestamp
DS11_UserKarmaLeaderboard ..> User : reads user id/username
DS11_UserKarmaLeaderboard ..> SortedData : returns snapshot
DS11_UserKarmaLeaderboard ..> SortedDataFactory : builds factory-backed snapshot
DS11_UserKarmaLeaderboard ..> AVLTree : exposes AVL snapshot
DS11_UserKarmaLeaderboard ..> BSTree : exposes BST snapshot
DS11_UserKarmaLeaderboard ..> SortedArrayList : exposes array snapshot
...
class Message
class User
DS11_UserKarmaLeaderboard ..> Post : accepts model object
DS11_UserKarmaLeaderboard ..> Message : accepts model object
DS11_UserKarmaLeaderboard ..> User : accepts model object
class SortedData
...
DS11_UserKarmaLeaderboard ..> SortedData : returns snapshot
DS11_UserKarmaLeaderboard ..> SortedDataFactory : builds snapshot
DS11_UserKarmaLeaderboard ..> AVLTree : builds AVL snapshot
DS11_UserKarmaLeaderboard ..> BSTree : builds BST snapshot
DS11_UserKarmaLeaderboard ..> SortedArrayList : builds array snapshot
```
