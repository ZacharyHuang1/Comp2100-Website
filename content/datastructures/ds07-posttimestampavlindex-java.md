...
DS07_PostTimestampAVLIndex is a Mock_hackathon practice implementation for DS07: Post timestamp AVL index. It is stored separately from the original MiniLab packages so it can be studied as an extension-style hackathon task without changing the base codebase.

The feature is: Get newest, oldest, and range of posts by creation time. The task is: Use balanced sorted storage keyed by timestamp and postId.
...
PlantUML guidance:
DS07_PostTimestampAVLIndex ..> Post : reads post id/topic
DS07_PostTimestampAVLIndex ..> Message : reads message id/text/timestamp
DS07_PostTimestampAVLIndex ..> User : reads user id/username
DS07_PostTimestampAVLIndex ..> SortedData : returns snapshot
DS07_PostTimestampAVLIndex ..> SortedDataFactory : builds factory-backed snapshot
DS07_PostTimestampAVLIndex ..> AVLTree : exposes AVL snapshot
DS07_PostTimestampAVLIndex ..> BSTree : exposes BST snapshot
DS07_PostTimestampAVLIndex ..> SortedArrayList : exposes array snapshot

## UML

```mermaid
classDiagram
class DS07_PostTimestampAVLIndex {
...
class Message
class User
DS07_PostTimestampAVLIndex ..> Post : accepts model object
DS07_PostTimestampAVLIndex ..> Message : accepts model object
DS07_PostTimestampAVLIndex ..> User : accepts model object
class SortedData
...
DS07_PostTimestampAVLIndex ..> SortedData : returns snapshot
DS07_PostTimestampAVLIndex ..> SortedDataFactory : builds snapshot
DS07_PostTimestampAVLIndex ..> AVLTree : builds AVL snapshot
DS07_PostTimestampAVLIndex ..> BSTree : builds BST snapshot
DS07_PostTimestampAVLIndex ..> SortedArrayList : builds array snapshot
```
...
/**
 * DS07 practice implementation for post timestamp AVL index.
 */
public class DS07_PostTimestampAVLIndex {
    private final TreeMap<Long, Set<UUID>> values = new TreeMap<>();

    // Creates an empty range index.
    public DS07_PostTimestampAVLIndex() {
    }
