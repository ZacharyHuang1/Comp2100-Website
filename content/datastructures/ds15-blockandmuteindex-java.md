...
DS15_BlockAndMuteIndex is a Mock_hackathon practice implementation for DS15: Block and mute index. It is stored separately from the original MiniLab packages so it can be studied as an extension-style hackathon task without changing the base codebase.

The feature is: Hide content from blocked or muted users. The task is: Map blocker to blocked users and muted topics.
...
PlantUML guidance:
DS15_BlockAndMuteIndex ..> Post : reads post id/topic
DS15_BlockAndMuteIndex ..> Message : reads message id/text/timestamp
DS15_BlockAndMuteIndex ..> User : reads user id/username

## UML

```mermaid
classDiagram
class DS15_BlockAndMuteIndex {
...
class Message
class User
DS15_BlockAndMuteIndex ..> Post : accepts model object
DS15_BlockAndMuteIndex ..> Message : accepts model object
DS15_BlockAndMuteIndex ..> User : accepts model object
```
...
/**
 * DS15 practice implementation for block and mute index.
 */
public class DS15_BlockAndMuteIndex {
