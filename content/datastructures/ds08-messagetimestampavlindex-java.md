...
DS08_MessageTimestampAVLIndex is a Mock_hackathon practice implementation for DS08: Message timestamp AVL index. It is stored separately from the original MiniLab packages so it can be studied as an extension-style hackathon task without changing the base codebase.

The feature is: Keep messages in chronological order for a thread. The task is: Use SortedData<Message> to store messages by timestamp/thread/poster/id.
...
PlantUML guidance:
DS08_MessageTimestampAVLIndex ..> Post : reads post id/topic
DS08_MessageTimestampAVLIndex ..> Message : reads message id/text/timestamp
DS08_MessageTimestampAVLIndex ..> User : reads user id/username
DS08_MessageTimestampAVLIndex ..> SortedData : returns snapshot
DS08_MessageTimestampAVLIndex ..> SortedDataFactory : builds factory-backed snapshot
DS08_MessageTimestampAVLIndex ..> AVLTree : exposes AVL snapshot
DS08_MessageTimestampAVLIndex ..> BSTree : exposes BST snapshot
DS08_MessageTimestampAVLIndex ..> SortedArrayList : exposes array snapshot

## UML

```mermaid
classDiagram
class DS08_MessageTimestampAVLIndex {
...
class Message
class User
DS08_MessageTimestampAVLIndex ..> Post : accepts model object
DS08_MessageTimestampAVLIndex ..> Message : accepts model object
DS08_MessageTimestampAVLIndex ..> User : accepts model object
class SortedData
...
DS08_MessageTimestampAVLIndex ..> SortedData : returns snapshot
DS08_MessageTimestampAVLIndex ..> SortedDataFactory : builds snapshot
DS08_MessageTimestampAVLIndex ..> AVLTree : builds AVL snapshot
DS08_MessageTimestampAVLIndex ..> BSTree : builds BST snapshot
DS08_MessageTimestampAVLIndex ..> SortedArrayList : builds array snapshot
```
...
/**
 * DS08 practice implementation for message timestamp AVL index.
 */
public class DS08_MessageTimestampAVLIndex {
    private final TreeMap<Long, Set<UUID>> values = new TreeMap<>();

    // Creates an empty range index.
    public DS08_MessageTimestampAVLIndex() {
    }
