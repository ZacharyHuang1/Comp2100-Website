...
DS03_HashtagIndex is a Mock_hackathon practice implementation for DS03: Hashtag index. It is stored separately from the original MiniLab packages so it can be studied as an extension-style hackathon task without changing the base codebase.

The feature is: Find posts/messages tagged with hashtags such as #java or #comp2100. The task is: Extract hashtags and map each tag to matching posts/messages.
...
PlantUML guidance:
DS03_HashtagIndex ..> Post : reads post id/topic
DS03_HashtagIndex ..> Message : reads message id/text/timestamp
DS03_HashtagIndex ..> User : reads user id/username

## UML

```mermaid
classDiagram
class DS03_HashtagIndex {
...
class Message
class User
DS03_HashtagIndex ..> Post : accepts model object
DS03_HashtagIndex ..> Message : accepts model object
DS03_HashtagIndex ..> User : accepts model object
```
...
/**
 * DS03 practice implementation for hashtag index.
 */
public class DS03_HashtagIndex {
