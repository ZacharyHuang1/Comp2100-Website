...
DS24_PostEditHistoryStack is a Mock_hackathon practice implementation for DS24: Post edit history stack. It is stored separately from the original MiniLab packages so it can be studied as an extension-style hackathon task without changing the base codebase.

The feature is: Store previous versions for reverting edits. The task is: Stack per post id.
...
PlantUML guidance:
DS24_PostEditHistoryStack ..> Post : reads post id/topic
DS24_PostEditHistoryStack ..> Message : reads message id/text/timestamp
DS24_PostEditHistoryStack ..> User : reads user id/username
...
class Message
class User
DS24_PostEditHistoryStack ..> Post : accepts model object
DS24_PostEditHistoryStack ..> Message : accepts model object
DS24_PostEditHistoryStack ..> User : accepts model object
```
