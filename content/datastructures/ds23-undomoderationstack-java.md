...
DS23_UndoModerationStack is a Mock_hackathon practice implementation for DS23: Undo moderation stack. It is stored separately from the original MiniLab packages so it can be studied as an extension-style hackathon task without changing the base codebase.

The feature is: Undo delete/ban/lock actions in reverse order. The task is: Stack of moderation actions.
...
PlantUML guidance:
DS23_UndoModerationStack ..> Post : reads post id/topic
DS23_UndoModerationStack ..> Message : reads message id/text/timestamp
DS23_UndoModerationStack ..> User : reads user id/username
...
class Message
class User
DS23_UndoModerationStack ..> Post : accepts model object
DS23_UndoModerationStack ..> Message : accepts model object
DS23_UndoModerationStack ..> User : accepts model object
```
